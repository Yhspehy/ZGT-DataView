...
const borderBox5Ref = ref<HTMLInputElement | null>(null)
const width = ref(0)
const height = ref(0)

onMounted(() => {
  width.value = borderBox5Ref.value!.clientWidth
  height.value = borderBox5Ref.value!.clientHeight
})
</script>

<template>
  <div class="borderBox5" ref="borderBox5Ref">
